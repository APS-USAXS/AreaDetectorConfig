...
<!--
    ...
    # $Author: jemian $
    # $Revision: 7995 $
    # $HeadURL: https://subversion.xray.aps.anl.gov/bcdaioc/9idc_AD/area_detector/SAXS_config/nexus_plugin/template.sch $
    # $Id: template.sch 7995 2015-02-20 16:56:46Z jemian $
    ########### SVN repository information ###################
-->
